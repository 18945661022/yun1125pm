...
extern MTLCommandBufferRef	UnityCurrentMTLCommandBuffer();
...
MTLTextureRef			UnityRenderBufferMTLTexture(void* buffer);
...
MTLTextureRef			UnityRenderBufferAAResolvedMTLTexture(void* buffer);
// queries stencil texture from depth RenderBuffer (might be nil). Returns nil for color RenderBuffer
MTLTextureRef			UnityRenderBufferStencilMTLTexture(void* buffer);
