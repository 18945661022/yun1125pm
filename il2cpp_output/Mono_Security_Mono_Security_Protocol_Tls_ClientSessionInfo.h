...
struct  ClientSessionInfo_t1348  : public Object_t
{
	...
	ByteU5BU5D_t129* ___sid_4;
	// System.Byte[] Mono.Security.Protocol.Tls.ClientSessionInfo::masterSecret
	ByteU5BU5D_t129* ___masterSecret_5;
};
struct ClientSessionInfo_t1348_StaticFields{
