...
struct  MonoCameraConfiguration_t687  : public Object_t
{
	// UnityEngine.Camera Vuforia.MonoCameraConfiguration::mPrimaryCamera
	Camera_t102 * ___mPrimaryCamera_0;
	...
	Action_t3 * ___mOnVideoBackgroundConfigChanged_3;
	...
	Dictionary_2_t688 * ___mVideoBackgroundBehaviours_4;
	// UnityEngine.Rect Vuforia.MonoCameraConfiguration::mViewportRect
	Rect_t19  ___mViewportRect_5;
