...
struct  StereoCameraConfiguration_t689  : public MonoCameraConfiguration_t687
{
	// UnityEngine.Camera Vuforia.StereoCameraConfiguration::mSecondaryCamera
	Camera_t102 * ___mSecondaryCamera_17;
