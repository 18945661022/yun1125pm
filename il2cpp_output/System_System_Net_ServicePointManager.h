...
struct  ServicePointManager_t1430  : public Object_t
{
};
struct ServicePointManager_t1430_StaticFields{
	// System.Collections.Specialized.HybridDictionary System.Net.ServicePointManager::servicePoints
	HybridDictionary_t1455 * ___servicePoints_0;
	...
	RemoteCertificateValidationCallback_t1440 * ___server_cert_cb_9;
};
