...
struct  SimpleCollator_t1686  : public Object_t
{
	...
	CodePointIndexer_t1672 * ___cjkIndexer_6;
	...
	CodePointIndexer_t1672 * ___cjkLv2Indexer_8;
...
struct SimpleCollator_t1686_StaticFields{
	...
	SimpleCollator_t1686 * ___invariant_1;
};
